    <!doctype html>
        ...
        <!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor-v3/singleProduct.html by HTTrack Website
        Copier/3.x [XR&CO'2014], Thu, 12 Sep 2019 08:49:15 GMT -->
        <head>
        <meta charset="utf-8">
        ...
        <a href="Public/images/1.html"><img src="Public/images/product/1.jpg" alt=""></a>
        ...
        <p>Ideal for cold-weather training or work outdoors, the Chaz Hoodie promises superior warmth with every wear.
        ...
        <p>Ideal for cold-weather training or work outdoors, the Chaz Hoodie promises superior warmth with every wear.
        Thick material blocks out the wind as ribbed cuffs and bottom band seal in body heat.Ideal for cold-weather
        training or work outdoors, the Chaz Hoodie promises superior warmth with every wear. Thick material blocks out
        the wind as ribbed cuffs and bottom band seal in body heat.Ideal for cold-weather training or work outdoors, the
        Chaz Hoodie promises superior warmth with every wear. Thick material blocks out the wind as ribbed cuffs and
        bottom band seal in body heat.Ideal for cold-weather training or work outdoors, the Chaz Hoodie promises
        superior warmth with every wear. Thick material blocks out the wind as ribbed cuffs and bottom band seal in body
        heat.</p>
        <ul>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="Public/images/books/2.jpg" alt="product
        image"></a>
        <div class="hot__box">
        ...
        <h4><a href="singleProduct.html">robin parrish</a></h4>
        ...
        <li><a data-toggle="modal" title="Quick View" class="quickview modal-view detail-link" href="#productmodal"><i
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="Public/images/books/4.jpg" alt="product
        image"></a>
        ...
        <div class="product__content content--center">
        <h4><a href="singleProduct.html">The Remainng</a></h4>
        <ul class="prize d-flex">
        <li>$35.00</li>
        <li class="old_prize">$35.00</li>
        </ul>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="Public/images/books/8.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">HOT</span>
        </div>
        ...
        <div class="product__content content--center">
        <h4><a href="singleProduct.html">Lando</a></h4>
        <ul class="prize d-flex">
        <li>$35.00</li>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="Public/images/books/10.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">HOT</span>
        </div>
        ...
        <div class="product__content content--center">
        <h4><a href="singleProduct.html">Doctor Wldo</a></h4>
        <ul class="prize d-flex">
        <li>$35.00</li>
        <li class="old_prize">$35.00</li>
        </ul>
        ...
        <div class="product__thumb">
        <a class="first__img" href="singleProduct.html"><img src="Public/images/books/1.jpg" alt="product image"></a>
        <a class="second__img animation1" href="singleProduct.html"><img src="Public/images/books/6.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">BEST SALER</span>
        </div>
