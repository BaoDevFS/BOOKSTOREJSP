...
<!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor-v3/error404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Sep 2019 08:49:15 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="col-lg-12">
						<div class="error__inner text-center">
							<div class="error__logo">
								<a href="#"><img src="Public/images/others/404.png" alt="error images"></a>
							</div>
							<div class="error__content">
								...
								<div class="search_form_wrapper">
									<form action="#">
										<div class="form__box">
											<input type="text" placeholder="SearchPublic.">
