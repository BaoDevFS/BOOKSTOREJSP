    <!doctype html>
        ...
        <!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor-v3/cart.html by HTTrack Website Copier/3.x
        ...
        <tbody>
        <tr>
        <td class="product-thumbnail"><a href="#"><img src="Public/images/product/sm-3/1.jpg" alt="product
        img"></a></td>
        ...
        <tr>
        <td class="product-thumbnail"><a href="#"><img src="Public/images/product/sm-3/2.jpg" alt="product
        img"></a></td>
        ...
        <tr>
        <td class="product-thumbnail"><a href="#"><img src="Public/images/product/sm-3/3.jpg" alt="product
        img"></a></td>
