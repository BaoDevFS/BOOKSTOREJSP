    <!doctype html>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/2.jpg" alt="product
        image"></a>
        <div class="hot__box">
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/4.jpg" alt="product
        image"></a>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/8.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">HOT</span>
        </div>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/10.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">HOT</span>
        </div>
        ...
        <div class="product__thumb">
        <a class="first__img" href="singleProduct.html"><img src="../images/books/1.jpg" alt="product image"></a>
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/6.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">BEST SALER</span>
        </div>
        ...
        <div class="product__content content--center content--center">
        <h4><a href="singleProduct.html">Soad Humber</a></h4>
        <ul class="prize d-flex">
        <li>$50.00</li>
        <li class="old_prize">$35.00</li>
        </ul>
        ...
        <div class="product__thumb">
        <a class="first__img" href="singleProduct.html"><img src="../images/books/7.jpg" alt="product image"></a>
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/3.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">BEST SALER</span>
        </div>
        ...
        <div class="product__thumb">
        <a class="first__img" href="singleProduct.html"><img src="../images/books/1.jpg" alt="product image"></a>
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/books/5.jpg" alt="product
        image"></a>
        <div class="hot__box">
        <span class="hot-label">BEST SALER</span>
        </div>
        ...
        <div class="product__content content--center content--center">
        <h4><a href="singleProduct.html">War Of Dragon</a></h4>
        <ul class="prize d-flex">
        <li>$50.00</li>
        <li class="old_prize">$35.00</li>
        </ul>
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/product/2.jpg" alt="product
        images"></a>
        </div>
        <div class="content">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue nec est tristique auctor. Donec
        non est at libero vulputate rutrum. Morbi ornare lectus quis justo gravida semper. Nulla tellus mi, vulputate
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/product/4.jpg" alt="product
        images"></a>
        </div>
        <div class="content">
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/product/6.jpg" alt="product
        images"></a>
        </div>
        <div class="content">
        ...
        <a class="second__img animation1" href="singleProduct.html"><img src="../images/product/9.jpg" alt="product
        images"></a>
        </div>
        <div class="content">
