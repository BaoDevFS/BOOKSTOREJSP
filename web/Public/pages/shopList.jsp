...
<head>
    ...
    <title>Shop-List |  BookBGQ Store</title>
...
<div class="wrapper" id="wrapper">
    ...
    <div class="page-shop-sidebar left--sidebar bg--white section-padding--lg">
                            ...
                            <div class="row">
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/1.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/2.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/3.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/4.jpg" alt="product
        image"></a>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/7.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/8.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">HOT</span>
                                        </div>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/9.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/10.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">HOT</span>
                                        </div>
                                ...
                                <div class="product product__style--3col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/1.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/6.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">BEST SALER</span>
                                        </div>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/7.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/3.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">BEST SALER</span>
                                        </div>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/1.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/5.jpg" alt="product
        image"></a>
                                        <div class="hot__box">
                                            <span class="hot-label">BEST SALER</span>
                                        </div>
        ...
        image"></a>
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="singleProduct.html"><img src="../images/books/5.jpg"
                                                                                             alt="product image"></a>
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/books/8.jpg" alt="product
        image"></a>
                            ...
                            <div class="list__view__wrapper">
                                ...
                                <div class="list__view">
                                    <div class="thumb">
                                        ...
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/product/2.jpg" alt="product
        images"></a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue
                                            nec est tristique auctor. Donec
                                            non est at libero vulputate rutrum. Morbi ornare lectus quis justo gravida
                                            semper. Nulla tellus mi, vulputate
                                ...
                                <div class="list__view mt--40">
                                    <div class="thumb">
                                        ...
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/product/4.jpg" alt="product
        images"></a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="list__view mt--40">
                                    <div class="thumb">
                                        ...
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/product/6.jpg" alt="product
        images"></a>
                                    </div>
                                    <div class="content">
        ...
        images"></a>
                                ...
                                <div class="list__view mt--40">
                                    <div class="thumb">
                                        ...
                                        <a class="second__img animation1" href="singleProduct.html"><img
                                                src="../images/product/9.jpg" alt="product
        images"></a>
                                    </div>
                                    <div class="content">
