...
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Oct 2019 13:21:48 GMT -->
<head>
...
<!--                </div>-->
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    ...
                    <li><a href="packageAll.html" class="waves-effect"><i class="fa fa-umbrella" aria-hidden="true"></i> Tour Packages</a>
                    </li>
                    ...
                    <li><a href="userAdd.html" class="waves-effect"><i class="fa fa-user-plus" aria-hidden="true"></i> Add New User</a>
                    </li>
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="index2.html"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <!--== DASHBOARD INFO ==-->
