...
<html lang="en">
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/setting.html by HTTrack Website Copier/3.x
[XR&CO'2014], Wed, 23 Oct 2019 13:21:48 GMT -->
<head>
                                ...
                                <form>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input id="website" type="text" value="www.websitename.com"
                                                   class="validate">
                                            <label for="website">Website</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input id="blog_name" type="text" value="www.websitename.com/blog"
                                                   class="validate">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input id="f_name" type="text" value="www.websitename.com/facebook"
                                                   class="validate">
                                            <label for="f_name">Facebook</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input id="g_name" type="text" value="www.websitename.com/google plus"
                                                   class="validate">
