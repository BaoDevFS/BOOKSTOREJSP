        ...
        <div class="sb2-1">
            ...
            <div class="sb2-13">
                <ul class="collapsible" data-collapsible="accordion">
                    <li><a href="admin/index.html" class="menu-active"><i class="fa fa-bar-chart"
                    ...
                    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella"
                        ...
                        <div class="collapsible-body left-sub-menu">
                            <ul>
                                ...
                                <li><a href="admin/pages/packageAdd.html">Add New Package</a>
                                </li>
                    ...
                    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-usd"
                                                                                   aria-hidden="true"></i> Discounts</a>
                        <div class="collapsible-body left-sub-menu">
                            <ul>
                    ...
                    <li><a href="admin/pages/login.html" target="_blank"><i class="fa fa-sign-in"
