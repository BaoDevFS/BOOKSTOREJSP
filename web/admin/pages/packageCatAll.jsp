...
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/packageCatAll.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Oct 2019 13:21:52 GMT -->
<head>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Tour Packages</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="admin/pages/packageCatAll.html">All Package Categories</a>
                                    </li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>24 may, 2017</td>
                                    <td><a href="packageCatEdit.html" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    </td>
