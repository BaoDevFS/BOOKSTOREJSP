...
<!-- Mirrored from demo.hasthemes.com/boighor-preview/boighor-v3/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Sep 2019 08:49:15 GMT -->
<head>
	<meta charset="utf-8">
			...
			<div class="row">
				<div class="col-lg-8 col-12">
					<div class="contact-form-wrap">
						...
						<form id="contact-form" action="https://demo.hasthemes.com/boighor-preview/boighor-v3/mail.php" method="post">
						...
						<div class="footer__widget footer__menu">
							...
							<div class="footer__content">
								...
								<ul class="mainmenu d-flex justify-content-center">
									...
									<li><a href="Public/index.html">Best Seller</a></li>
									<li><a href="Public/index.html">All Product</a></li>
									<li><a href="Public/index.html">Wishlist</a></li>
									<li><a href="Public/index.html">Blog</a></li>
